...
sales_order = spark.sql("SELECT * FROM main.dev_manual.sales_order")
customer = spark.sql("SELECT * FROM main.dev_manual.customer")
...
sales_orders_cleaned.write.saveAsTable("main.dev_manual.sales_orders_cleaned")
